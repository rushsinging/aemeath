...
## 3.12.2. 工具调用的 TUI 显示（ToolDisplayEntry）
...
### 3.12.3.6. 各工具 render_policy 配置表
...
## 3.12.4. 主题色板（Catppuccin Macchiato）
...
## 3.12.5. Agent tool call 显示

### 3.12.5.1. AgentProgressEvent 数据流
