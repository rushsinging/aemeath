use crate::application::main_loop::looping::events::{ChatEventSink, RuntimeStreamEvent};
...
mod tests {
    use super::*;
    use crate::application::main_loop::looping::events::{EventFuture, RuntimeStreamEvent};
