...
use crate::application::main_loop::looping::tools::{
    ...
    S: ChatEventSink,
{
    ...
    if crate::application::main_loop::looping::hook_ui::dispatch_is_blocking(&pre_dispatch) {
    ...
    *ag_ctx = ag_ctx.with_progress(Some(crate::application::tool_execution_adapters::progress(
    ...
    let execution = ToolExecution::new(
        &effective_call,
        crate::application::subagent::agent::legacy_outcome(outcome),
    );
