...
fn format_grouped_tool_summaries(
    tool_calls: &[crate::application::tool::agent::ToolCall],
) -> String {
...
fn llm_output_log_preserves_per_invocation_elapsed_time() {
    let response = crate::application::loop_engine::chat::InvocationResponse {
...
async fn run_agent_rejects_disabled_role_from_frozen_run_config() {
    ...
    let _disabled_guard =
        runner
            .parent_context
            .install(Arc::new(crate::application::run::context::ParentRunFrame {
...
) -> crate::application::tool::agent::ToolCall {
...
fn test_parent_source() -> (
    crate::application::run::context::ParentRunContextSource,
    crate::application::run::context::ParentRunFrameGuard,
) {
    ...
    let guard = source.install(Arc::new(crate::application::run::context::ParentRunFrame {
        run_id: crate::domain::agent_run::RunId::new_v7(),
        spec: crate::domain::agent_run::RunSpec::main(),
        context: Arc::new(parent_ctx),
    }));
