...
use super::interaction::InteractionPort;
use super::session_ingress::{
    InteractionCommand, SessionIngress, SessionIngressCommand, SessionMailboxPort,
};
...
fn interaction_command_is_dispatched_through_ingress() {
    let bridge = Arc::new(crate::application::interaction::InteractionBridge::new());
