...
use crate::application::interaction::{InteractionCompletion, InteractionRequestMetadata};
...
impl RunExecutionState {
    ...
    pub(crate) fn committed_message_count(&self) -> usize {
        self.committed_message_count
    }

    pub(crate) fn commit_all_messages(&mut self) {
    ...
    pub(crate) fn messages_slice_from(&self, start: usize) -> &[Message] {
        &self.messages[start..]
    }
    ...
    pub(crate) fn accepted_input_len(&self) -> usize {
        self.accepted_input.len()
    }
