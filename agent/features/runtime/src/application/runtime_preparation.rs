...
pub struct PreparedRun {
    ...
    session: SessionSnapshot,
    context: Option<crate::application::runtime_context::RuntimeContext>,
}
...
impl PreparedRun {
    ...
    pub(crate) fn with_context(
        ...
        session: SessionSnapshot,
        context: crate::application::runtime_context::RuntimeContext,
    ) -> Self {
        Self {
            run: Run::new(spec, parent_run_id),
            execution: RunExecutionState::new(),
    ...
    pub fn context(&self) -> Option<&crate::application::runtime_context::RuntimeContext> {
        self.context.as_ref()
    }
    ...
    pub fn into_parts(
        ...
        RunExecutionState,
        SessionSnapshot,
        Option<crate::application::runtime_context::RuntimeContext>,
    ) {
