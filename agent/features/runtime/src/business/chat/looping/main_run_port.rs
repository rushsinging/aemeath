    ...
    I: InputEventDrainPort,
{
    ...
    pub(crate) token_budget: context::api::compact::TokenBudgetConfig,
    ...
    pub(crate) save_chain: &'a crate::business::chat::looping::loop_context::SaveChainFn,
    ...
    pub(crate) active_run: &'a dyn crate::business::agent_run::ActiveRunPort,
    ...
    pub(crate) tool_identity:
        &'a crate::business::chat::looping::tool_identity::ToolIdentityRegistry,
    ...
    I: InputEventDrainPort,
{
    ...
    async fn execute_tools(
        ...
        let has_task_mutation = all_results.iter().any(|result| {
            crate::business::chat::looping::events::is_task_store_mutation(&result.tool_name)
        });
        self.chain.push(
        ...
        if has_task_mutation {
            let snapshot =
                crate::business::chat::looping::task_snapshot::build_task_snapshot(self.task_store)
                    .await;
            self.sink
