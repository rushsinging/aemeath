...
pub use domain::{
    ...
    AgentToolCallProgress, ImageData, PathAccess, PathKind, PolicyDecision, ProfileExpansionError,
    ...
    ToolExecutionPort, ToolInvocation, ToolListProvider, ToolOutcome, ToolProfile, ToolProfileName,
