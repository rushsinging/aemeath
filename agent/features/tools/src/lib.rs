...
pub use domain::{
    ...
    ProgressSink, PromptCommand, ReadSet, RegistryScopeName, SessionReminder, SessionReminders,
    SkillCatalogPort, SkillDescriptor, SkillError, SkillLoadPort, SkillLoadQuery, SkillQuery,
    SkillSource, SkillSourceKind, SlashInput, SnapshotQueryCommand, SnapshotQueryTarget, Tool,
