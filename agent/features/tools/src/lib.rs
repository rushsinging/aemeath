...
pub use domain::{
    ...
    CancellationDeclaration, CancellationSignal, CatalogQuery, ChildRunActivityEvent,
    ChildRunActivityKind, ChildRunIdentity, ChildRunTerminalOutcome, CleanupConfirmation,
    ...
    SlashInput, SnapshotQueryCommand, SnapshotQueryTarget, TaskChangeFact, Tool, ToolCapabilities,
