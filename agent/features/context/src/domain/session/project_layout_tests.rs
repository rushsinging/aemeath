...
fn git_identity(common_dir: &str) -> ProjectIdentity {
    ProjectIdentity {
...
fn plain_identity(cwd: &str) -> ProjectIdentity {
    ProjectIdentity {
...
fn git_identity_and_plain_cwd_identity_never_collide_by_prefix() {
    let git_segment = project_dir_segment(&ProjectIdentity {
