...
fn retained_state_release_workload() {
    for scale in [100usize, 500, 1000] {
        ...
        println!(
            "scale={scale:>4} timeline={} sub_run_watermarks={} legacy_progress={} view_journal={} view_id_bytes={} roots={} assemble_ms={:.2} cold_ms={:.2} warm_ms={:.2} cache(block/gutted)={}/{} peak={}/{}",
            retained.timeline_items,
            retained.sub_run_watermarks,
            retained.legacy_agent_progress_entries,
