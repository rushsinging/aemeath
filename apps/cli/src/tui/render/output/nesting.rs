...
/// 仅 ToolCall 可含子（result 富渲染子块：AssistantMessage 文本 / Diagnostic / SystemNotice）；其余为叶子。
...
mod tests {
    use super::*;
    use crate::tui::view_model::output::{TextBlockView, ToolCallBlockView, ToolSemanticStatus};
