        ...
        if all {
            ...
            for task in tasks.iter().take(count) {
                ...
                let status = match task.status {
                    kernel::task::TaskStatus::Pending => "pending",
                    kernel::task::TaskStatus::InProgress => "in_progress",
                    kernel::task::TaskStatus::Completed => "completed",
                    kernel::task::TaskStatus::Deleted => "deleted",
                };
