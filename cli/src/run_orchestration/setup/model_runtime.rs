use aemeath_core::config::models::ModelEntryConfig;
use aemeath_core::config::{models::validate_reasoning_effort, Config};
...
mod tests {
    use super::*;
    use aemeath_core::config::models::ModelEntryConfig;
    use aemeath_core::config::{Config, ModelConfig};
