...
TOOLS_DOMAIN_FACADE = {
    ...
    "SkillCatalogPort", "SkillCatalogSnapshot", "SkillDescriptor", "SkillError",
    "SkillLoadDecision", "SkillLoadMutation", "SkillLoadPort", "SkillLoadQuery", "SkillLoadScope",
    "SkillLoadStateError", "SkillLoadStatePort", "SkillQuery", "SkillQuerySnapshot", "SkillRequestCommand",
    "SkillSlashRoute", "LoadedSkill", "SkillSource", "SkillSourceKind",
    "ApplicationControlCommand", "ApplicationControlTarget", "CommandArgumentSchema",
    "CommandCatalogPort", "CommandCompletion", "CommandDescriptor", "CommandMechanism",
...
ROOT_ACCESS_ALLOW = {
    ...
    "task": {
        ...
        "TaskPersist", "TaskPriority", "TaskPriorityStats", "TaskProgressItem",
        "TaskProgressSnapshot", "TaskRevision", "TaskSnapshot", "TaskSnapshotCodecError",
