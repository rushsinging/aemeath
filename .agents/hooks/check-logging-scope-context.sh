...
for file in \
  ...
  "$RUNTIME_SRC/application/loop_engine/chat/main_run_port.rs"; do
...
for file in \
  "$RUNTIME_SRC/application/loop_engine/chat/agent_calls.rs" \
  "$RUNTIME_SRC/application/loop_engine/chat/non_agent.rs"; do
