...
| 36 | Multi-Agent 框架 | 高 | 实施中 | 未确认 | Sprint 0/Sprint 0.5 已完成；当前推进 Sprint 1 Workspace/Chat API：REST Workspace/Chat/Message、PATCH Chat、AnalyzeMessage、WebSocket BoardSnapshot、ChatService/BoardService gRPC 骨架、gateway 配置与 idempotency_key 去重。详见 [spec](specs/036-multi-agent-framework.md) |
