...
| 51 | UI Domain DDD 设计 —— 将 apps/cli 提升为核心域 | 中 | 设计中 | 未确认 | 修正 #47 将 Interface 定位为薄入口的偏差：apps/cli 是独立核心域，内部划分 Display / Interaction / TEA Kernel / Session 四个 Bounded Context，与 Agent Runtime 对等。详见 [spec](specs/051-ui-domain-ddd.md) |
