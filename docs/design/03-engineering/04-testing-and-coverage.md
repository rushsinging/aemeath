...
- inline、同级 `*_tests.rs`、模块 `tests/`、crate integration test 与场景测试目录规则；
...
| 2026-07-15 | 将 L0-L5、覆盖证据、目录、命名、fixture 与确定性规则同步到 Rust 编码规范 | [#1013](https://github.com/rushsinging/aemeath/issues/1013) |
