...
| 日期 | 变更 | 关联 |
|---|---|---|
| 2026-07-20 | #1266 收紧 filesystem Skill 发现：标准目录与 package 仅解析 `SKILL.md`，同目录 Markdown 资源不进入 Catalog、Materialization 或 revision；真实入口损坏继续返回 typed error；skills 根目录直接 `*.md` 暂保留历史兼容 | [#1266](https://github.com/rushsinging/aemeath/issues/1266) |
