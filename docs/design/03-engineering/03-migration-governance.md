...
| PHA11 | **Audit Usage 能力尚未落地** | #988 已删除无领域语义的 AuditApiMarker / empty gateway；crate 暂只保留真实日志入口 | MVP 按真实能力建立 UsageRecord、UsageSink、UsageQueryPort、worker，NEVER 恢复空横向层 | S5 |
