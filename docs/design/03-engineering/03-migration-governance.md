...
| M5 | **Reflection 领域与执行/TUI 语义部分收口** | #898 迁移 PL、prompt/schema/parse/format/apply；#1284 已将 PreCompact 切入 Runtime 单槽异步协议；#900 删除文档中的旧 `MemoryStore` apply 示例，确认 `ReflectionEngine` 是当前无状态 `ReflectionPromptPort` 实现而非第二 active Memory state。Manual 显式入口与有界 teardown/cancel 分别由 #1289/#1285 承接 | 不得恢复同步执行、第二 store 选择或结果正文投影；Manual 与 teardown 完成前不得声明三 trigger / 生命周期语义已收口 | #898/#900 已完成；#1284 PreCompact 完成；#1289/#1285 待完成 |
...
| M9 | **NoOpMemory、Sub Disabled 与 Reflection 编排部分落地** | #897 发布 owner-owned NoOpMemory；Sub ToolResources 明确装配 NoOp，Composition MemoryMode::Shared 仅 clone active Arc；#1284 已接 PreCompact 单槽生产编排与 history view。Manual 显式入口及 teardown 收口仍由 #1289/#1285 承接 | #900 删除 Runtime 重复 MemoryPort 骨架；不改变已完成的 NoOp/Shared 语义；Manual 与 teardown 未完成前不得冒充完整 Reflection 编排 | #897/#900 已完成；#1284 PreCompact 完成；#1289/#1285 待完成 |
