...
| 2026-07-21 | #914 删除 legacy-no-agent 与 SkillTool 兼容实现；正式 Scope 只保留 Main/Sub，进度/计划资源的 Runtime 所有权收口由 #879 承接 | [#914](https://github.com/rushsinging/aemeath/issues/914) |
