...
| Main/Sub/physical request 与 retry request ID | L2/L4 | Runtime `application/run/derived/tests.rs`、`application/loop_engine/chat/*_tests.rs` | Main/Sub 相邻边界、并发角色与 retry ID 覆盖 |
