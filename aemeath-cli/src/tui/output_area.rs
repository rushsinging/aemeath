...
impl LineStyle {
    pub fn to_style(&self) -> Style {
        match self {
            ...
            LineStyle::ToolCallRunning => Style::default().fg(Color::Blue),
            LineStyle::ToolCallSuccess => Style::default().fg(Color::Blue),
            LineStyle::ToolCallError => Style::default().fg(Color::Red),
            LineStyle::ToolResult => Style::default().fg(Color::Green),
