...
pub async fn run_reflection(
    ...
    run_reflection_with_base_dir(
        ...
        client,
        system_prompt_text,
        crate::api::core::memory::memory_base_dir(),
    )
    .await
}
...
async fn run_reflection_with_base_dir(
    ...
    let mut store = MemoryStore::new(
        base_dir.clone(),
        crate::api::core::memory::project_hash_from_path(cwd),
        config.max_entries,
...
mod tests {
    use super::*;
    use crate::api::core::memory::{MemoryCategory, MemoryLayer, MemorySource, MemoryStore};
